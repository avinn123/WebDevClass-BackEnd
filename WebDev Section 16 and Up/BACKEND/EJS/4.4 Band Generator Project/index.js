...
app.post("/submit", (req, res) => {
  ...
  //3. Test to make sure that the random wods display in the h1 element in index.ejs

  let generatedName = getName(adj)+" "+getName(noun);
  // console.log(generatedName);
  res.render("index.ejs",{bandName:generatedName});

  function getName(arr){
    let randomNumber = Math.floor(Math.random() * (arr.length));
    let upperCaseName = arr[randomNumber][0].toUpperCase()+arr[randomNumber].slice(1);
